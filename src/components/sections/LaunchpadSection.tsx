...
const features = [
  ...
  },
  {
    ...
    description: "Creators run their own communities. Your league, your rules, your revenue.",
  },
  {
    icon: Globe,
    title: "Connected Communities",
    description: "Communities link together with shared governance. Bigger together.",
  },
  {
    icon: Sparkles,
    title: "MLC Utility",
    description: "Premium features, voting rights, and rewards. All unlocked with MLC.",
  },
];

const LaunchpadSection = () => {
  return (
    <section className="mlc-section bg-gradient-to-b from-secondary/30 to-background">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8">
              ...
              can build on top of what we have made. Think of it as your foundation.
            </p>
          ...
          >
            <div className="aspect-square max-w-md mx-auto relative">
              ...
              <div className="absolute inset-4 animate-spin" style={{ animationDuration: "25s", animationDirection: "reverse" }}>
              ...
              <div className="absolute inset-8 animate-spin" style={{ animationDuration: "30s" }}>

...
const rewards = [
  {
    ...
    description:
      "Create an account and finish onboarding. That is it. You get points just for showing up.",
  ...
  },
  {
    ...
    description:
      "Buy during presale and we throw in extra tokens on top. Early supporters get the bonus.",
  ...
  },
  {
    ...
    description:
      "Play games, run simulations, join leagues. The more active you are, the more you earn.",
      ...
      <div className="mlc-container px-4">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground">
            We pay you for doing what you already want to do. Play games, earn
            rewards. No tricks.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {rewards.map((reward, index) => (
            ...
            >
              <div
                className={`w-16 h-16 rounded-2xl ${reward.bgColor} flex items-center justify-center mx-auto mb-4`}
              >
              ...
              <div className="inline-block px-4 py-2 rounded-full bg-secondary">
                <span className={`font-semibold ${reward.color}`}>
                  {reward.reward}
                </span>
              </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Rewards are capped and based on real activity. MLC is not an
                  investment and there are{" "}
                  <strong>no guaranteed returns</strong>. You earn by playing,
